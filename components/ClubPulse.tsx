  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <Link href="/explore" className="block bg-[var(--color-dark-card)] border border-[#1f2937] rounded-xl p-4 relative overflow-hidden group hover:border-[var(--color-accent)]/50 transition-colors cursor-pointer">
      ...
      <div>
        ...
        <div className="flex gap-3 overflow-x-auto no-scrollbar pb-2">
          <div className="min-w-[200px] h-28 rounded-xl relative overflow-hidden border border-[#1f2937]">
            <img src="https://images.unsplash.com/photo-1599586120429-48281b6f0ece?w=400&auto=format&fit=crop&q=80" className="absolute inset-0 w-full h-full object-cover opacity-80" alt="Highlight 1" />
      ...
      <div>
        ...
        <div className="grid grid-cols-3 gap-2">
           <img src="https://images.unsplash.com/photo-1554068865-24cecd4e34f8?w=150&auto=format&fit=crop&q=80" className="w-full h-16 object-cover rounded-lg border border-[#1f2937]" alt="Social 1" />
           <img src="https://images.unsplash.com/photo-1622279457486-62dcc4a431d6?w=150&auto=format&fit=crop&q=80" className="w-full h-16 object-cover rounded-lg border border-[#1f2937]" alt="Social 2" />
           <img src="https://images.unsplash.com/photo-1595435934249-5df7ed86e1c0?w=150&auto=format&fit=crop&q=80" className="w-full h-16 object-cover rounded-lg border border-[#1f2937]" alt="Social 3" />
        </div>
      </div>
    </div>
  );
