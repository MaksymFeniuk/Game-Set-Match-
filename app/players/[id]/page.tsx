        ...
        <div className="col-span-12 lg:col-span-4">
          <div className="bg-[var(--color-dark-card)] border border-[#1f2937] rounded-xl p-8 relative overflow-hidden shadow-[0_0_30px_rgba(0,0,0,0.5)]">
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-2xl font-black text-center mb-3 text-white tracking-wide">{player.name}</h2>
              ...
              <div className="grid grid-cols-2 gap-3 mb-5">
                <div className="bg-[#090e17] border border-[#1f2937] rounded-lg p-4">
                  ...
                  <p className="text-2xl font-black text-[var(--color-cyan-glow)] tracking-wider">{player.padelLevel}</p>
                  <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest mt-1">{levelLabel(player.padelLevel)}</p>
                </div>
                <div className="bg-[#090e17] border border-[#1f2937] rounded-lg p-4">
                  <p className="text-slate-500 text-[10px] font-black tracking-widest mb-1.5">TENNIS</p>
                  <p className="text-2xl font-black text-[var(--color-accent)] tracking-wider">{player.tennisLevel}</p>
                  <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest mt-1">{levelLabel(player.tennisLevel)}</p>
                </div>
              </div>
        ...
        <div className="col-span-12 lg:col-span-8 space-y-8">
          <div className="bg-[var(--color-dark-card)] border border-[#1f2937] rounded-xl p-8 shadow-[0_0_30px_rgba(0,0,0,0.5)]">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-6">
              {[
                { label: 'Padel rating', value: player.padelLevel, color: 'text-[var(--color-cyan-glow)]' },
                { label: 'Tennis rating', value: player.tennisLevel, color: 'text-[var(--color-accent)]' },
